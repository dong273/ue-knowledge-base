...
- the released corpus snapshot: 90 markdown files and unique bounded chunks.
...
def test_package_version():
    assert ue_knowledge.__version__ == "0.6.3"
...
def test_default_corpus_90_files_readable():
